    ...
    <table>
        ...
        <tbody>
            ...
            <tr id="heading6" class="b-black collapsed" data-toggle="collapse" data-target="#collapse6">
                <th><i class="fa"></i> Short 5 (ad hoc)</th>
                <td>7:45am</td>
                <td>17mph+</td>
                <td>30&ndash;35 miles</td>
                <td>2½ hours</td>
        ...
        <tbody>
            ...
            <tr id="heading7" class="b-blue collapsed" data-toggle="collapse" data-target="#collapse7">
                <th><i class="fa"></i> Long 1 (ad hoc)</th>
                <td>8:05am</td>
                <td>11-12mph</td>
            ...
            <tr id="heading8" class="b-blue collapsed" data-toggle="collapse" data-target="#collapse8">
            ...
            <tr id="collapse9" class="b-red collapse" data-parent="#accordion">
                <td colspan="6">
            ...
            <tr id="heading11" class="b-black collapsed" data-toggle="collapse" data-target="#collapse11">
                <th><i class="fa"></i> Long 5 (ad hoc)</th>
                <td>7:45am</td>
                <td>18mph+</td>
                <td>60&ndash;75 miles</td>
                <td>4½ to 5 hours</td>
        ...
        <tbody>
            ...
            <tr id="heading12" class="collapsed" data-toggle="collapse" data-target="#collapse12">
                <th colspan="5"><i class="fa"></i> Special</th>
            </tr>
            <tr id="collapse12" class="collapse" data-parent="#accordion">
                <td colspan="6">
                  We don’t run these every week, so look out for announcements. They are aimed at experienced and fit riders looking to train over a longer distance, perhaps for an organised sportive event.<br />
