...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_style( 'understrap-styles-custom', get_stylesheet_directory_uri() . '/css/custom.css', array(), $css_version );
		...
		wp_enqueue_script( 'understrap-scripts-custom', get_template_directory_uri() . '/js/custom.js', array(), $js_version, true );
